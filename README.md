...
Label|Note|Value|Authority|Title|URL
---|---|---|---|---|---
Age below which youth are considered infants.||4|Operational Value||
...
Average number of days that coronavirus can survive on surfaces|The given range says 'up to' a few hours or days, depending on material. This average will produce that range because rates (where this value is used) are drawn from a poisson distribution. Quote: COVID-19 coronavirus can survive up to four hours on copper, up to 24 hours on cardboard, and up to two to three days on plastic and stainless steel. The researchers also found that this virus can hang out as droplets in the air for up to three hours before they fall. But most often they will fall more quickly.|1.0|Harvard Health Publishing|How long can the coronavirus that causes COVID-19 survive on surfaces?|https://www.health.harvard.edu/diseases-and-conditions/covid-19-basics
Death rate for all cases by age group|The table in the cited URL is based on (1) The Report of the WHO-China Joint Mission published on Feb. 28 by WHO, which is based on 55,924 laboratory confirmed cases and (2) A paper by the Chinese CCDC released on Feb. 17, which is based on 72,314 confirmed, suspected, and asymptomatic cases of COVID-19 in China as of Feb. 11, and was published in the Chinese Journal of Epidemiology. Quote: 'Death Rate = (number of deaths / number of cases) = probability of dying if infected by the virus (%).'|Table Function; Linear  interpolation; If argument is out of range: uses nearest argument's value; 9 rows; 0	0; 10	0.2; 20	0.2; 30	0.2; 40	0.4; 50	1.3; 60	3.6; 70	8; 80	14.8; ||Age, Sex, Existing Conditions of COVID-19 Cases and Deaths|https://www.worldometers.info/coronavirus/coronavirus-age-sex-demographics/
Death rate in confirmed COVID cases in 80+ category|This value is used for sense-checking results and is to be used when examining confirmed COVID cases (which we assume to be symptomatic)|21.9||Age, Sex, Existing Conditions of COVID-19 Cases and Deaths|https://www.worldometers.info/coronavirus/coronavirus-age-sex-demographics/
Earliest included grade, primary schools||0|Placeholder||
Earliest included grade, secondary schools||7|Placeholder||
Factor applied to death rate if person sick enough to be admitted to hospital.|Death rates are often reported on average; averages will mask the fact that hospitalization increases likelihood of death (and vice versa)|5.0|Placeholder||
Factor applied to death rate if sick person was not ill enough to be admitted to hospital|Death rates are often reported on average; averages will mask the fact that hospitalization increases likelihood of death (and vice versa)|0.2|Placeholder||
Hour at which people leave the house in the morning||8|Operational Value||
Hour at which people sleep||22|Operational Value||
Hours spent on break, primary schools||1|Placeholder||
Hours spent on break, secondary schools||0.75|Placeholder||
Hours spent on learning, primary schools||5.25|Placeholder||
Hours spent on learning, secondary schools||5.5|Placeholder||
Hours that a person spends at their daytime location each day (e.g. school, work)||8|Operational Value||
Hours that a person spends at their evening location (e.g. going to shop, going to restaurant, etc.)||2|Operational Value||
Is social distancing possible at schools?||false|Placeholder||
Latest included grade, primary schools||6|Placeholder||
Latest included grade, secondary schools||12|Placeholder||
Maximum distance (km) that someone will drive for a day job.||50.0|Placeholder||
Maximum distance (km) that someone will drive to non-work locations.||100.0|Placeholder||
Maximum distance (km) that someone will drive to school.||100.0|Placeholder||
Maximum number of non-work options.||10.0|Placeholder||
Maximum number of people exposed in each conversation to COVID (if the speaker has it)||5|Placeholder||
Minutes spent entering school and exiting school||30.0|Placeholder||
Modifier applied to p(transmission in conversation) when social distancing activated|Lancet study. Quote: 'The chance of transmission at a distance of less than 1 meter (3.3 feet) was 12.8%, while that fell to 2.6% at a distance of more than 1 meter (3.3 feet). It added that distances of 2 meters (6.6 feet) could be more effective.'Note that we purposefully do not use the averaged 12.8 transmission rate. The average in the paper is derived from research where infected individuals regularly and very closely interact with others (e.g. lots of healthcare worker / patient interaction research). This is consistent with other papers showing high transmission rates with family members and those directly on shared transport. Since our model uses all interaction types (both brief and long and/or repeated), we skew to a lower rate. However, we can still use this research to identify the effect of social distancing as the averages are derived from the same source.|0.203125|CNN|Social distancing and masks reduce risk of getting Covid-19, review finds|https://www.cnn.com/2020/06/01/health/review-masks-social-distancing-covid-19-wellness/index.html
...
P(Hospitalization \| Symptomatic)||Table Function; Linear  interpolation; If argument is out of range: uses nearest argument's value; 9 rows; 0	0; 10	0.1; 20	1; 30	3.4; 40	4.3; 50	8.2; 60	11.8; 70	16.6; 80	19; ||Odds of Hospitalization, Death with COVID-19 Rise Steadily With Age: Study|https://www.usnews.com/news/health-news/articles/2020-03-30/odds-of-hospitalization-death-with-covid-19-rise-steadily-with-age-study
